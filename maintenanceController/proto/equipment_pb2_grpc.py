...
class SchedulerStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ScheduleMaintenance = channel.unary_unary(
                '/grpc.Scheduler/ScheduleMaintenance',
                request_serializer=equipment__pb2.Equipment.SerializeToString,
                response_deserializer=equipment__pb2.Response.FromString,
                )
...
def add_SchedulerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ScheduleMaintenance': grpc.unary_unary_rpc_method_handler(
                    servicer.ScheduleMaintenance,
                    request_deserializer=equipment__pb2.Equipment.FromString,
                    response_serializer=equipment__pb2.Response.SerializeToString,
            ),
    }
...
class Scheduler(object):
    ...
    def ScheduleMaintenance(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/grpc.Scheduler/ScheduleMaintenance',
            equipment__pb2.Equipment.SerializeToString,
            equipment__pb2.Response.FromString,
